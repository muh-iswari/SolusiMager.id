...
public class SembakoScene {
    ...
    String[] listImagePath = {"/gambar/tropical.jpg","/gambar/beras.jpg", "/gambar/Terigu.jpg",
    "/gambar/gula.jpg","/gambar/telur.jpg", "/gambar/garam.jpg"};
    String[] nama = {"Minyak tropical 1 Liter", "Beras 5 kg Beraskita ", "Terigu 5 kg Terigukita",
    "Gula murni 1 kg merek Gulaku", "Telur 1 rak", "Garam masak cap Segi Tiga Emas"};
    int[] stock = {10, 6, 11, 25, 30, 23};
    int[] harga = {18000, 48000, 12000, 16000, 50000, 8000};

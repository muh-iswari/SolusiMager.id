...
public class PTubuhScene {
    ...
    String[] listImagePath = {"/gambar/sabun.jpg", "/gambar/rexona.jpg", 
    "/gambar/lulur.jpeg", "/gambar/citra.jpg", 
    "/gambar/cuciMuka.jpg", "/gambar/Sampo.jpg" };
    String[] nama = {"Sabun Zen antibackterial", "Rexona man lime cool", "Lulur mandi pengantin Purbasari", 
    "Citra Phearly White UV" ,"POND'S Man oil blaster spesial Star War", "Head & Shoulders Supreme Moisture"};
    int[] stock = {12, 15, 5, 21, 6, 22};
    int[] harga = {18000, 20000, 34000, 24000, 28500, 9000};
